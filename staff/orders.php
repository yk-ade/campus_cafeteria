...
<section class="order-history-section">
    <div class="container">
        <h1 class="section-title">Kitchen Order Queue</h1>
        <p class="section-subtitle">View incoming student orders, see what they ordered, and update progress in real time.</p>
                ...
                <?php while ($order = $result->fetch_assoc()): ?>
                    ...
                    <div class="order-detail-card">
                        ...
                        <div class="order-card-footer">
                            <form action="<?php echo qb_url('staff/update-order.php'); ?>" method="POST" class="order-update-form">
