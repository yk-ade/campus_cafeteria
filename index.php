...
<section class="hero">
    <div class="container hero-content">
        <div class="hero-text">
            ...
            <p>Rectem Resturant helps students browse meals, place orders for pickup or campus delivery, track progress in real time, and enjoy a smoother cafeteria experience.</p>
        ...
        <div class="hero-image-card">
            <img src="<?php echo qb_url('assets/images/foods/1779144763_Nigerian_Assorted_Peppered_Meats_-_Party_Style.jfif'); ?>" alt="Rectem Resturant hero">
        </div>
    </div>
</section>
...
<section class="categories">
    <div class="container">
        ...
        <p class="section-subtitle">Built on the same smooth UI logic as Rectem Resturant , but adapted for campus food service operations.</p>
